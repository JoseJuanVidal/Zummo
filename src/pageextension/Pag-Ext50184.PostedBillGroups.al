pageextension 50184 "PostedBillGroups" extends "Posted Bill Groups"
{
    layout
    {
        addfirst(FactBoxes)
        {
            part(Errors; "Payment Journal Errors Part")
            {
                ...
                SubPageLink = "Journal Template Name" = FILTER(''),
                    "Journal Batch Name" = FILTER(7000006),
        ...
        addafter("&Navigate")
        {
            action(Export)
            {
                ...
                begin
                    ...
                    DirectDebitCollection."Source Table ID" := DATABASE::"Posted Bill Group";
