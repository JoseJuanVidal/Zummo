page 50005 "PageMatricesComprasProovedor"
{
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(MatrizCompraProveedor; MatrizCompraProveedor)
            {
                ApplicationArea = All;
            }

            part(MatrizCompraProveedor2; MatrizCompraProveedor)
            {
                ApplicationArea = All;
            }
        }
    ...
    begin
        ...
        CurrPage.MatrizCompraProveedor.Page.Inicializa(true);
        CurrPage.MatrizCompraProveedor.Page.Load(MATRIX_CaptionSet, MATRIX_MatrixRecords, MATRIX_CurrentSetLenght);
        CurrPage.MatrizCompraProveedor.Page.Update(true);

        CurrPage.MatrizCompraProveedor2.Page.Inicializa(false);
        CurrPage.MatrizCompraProveedor2.Page.Load(MATRIX_CaptionSet, MATRIX_MatrixRecords, MATRIX_CurrentSetLenght);
        CurrPage.MatrizCompraProveedor2.Page.Update(true);
    end;
