table 50140 "CRM FormasPago_crm_btc"
{
    ...
    fields
    {
        field(1; bit_bcformadepagoId; Guid)
        {
            Caption = 'Forma de pago BC';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'bit_bcformadepagoid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the Forma de pago BC';
        ...
        field(14; statuscode; Option)
        {
            ...
            Description = 'Reason for the status of the Forma de pago BC';
