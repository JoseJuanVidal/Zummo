table 50137 "CRM Delegado_crm_btc"
{
    Caption = 'Delegado BC';
    Description = '';
    ...
    fields
    {
        field(1; zum_bcdelegadoId; Guid)
        {
            Caption = 'Delegado BC';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'zum_bcdelegadoid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the Delegado BC';
        ...
        field(14; statuscode; Option)
        {
            ...
            Description = 'Reason for the status of the Delegado BC';
