table 50141 "CRM TerminosPago_crm_btc"
{
    Caption = 'Término de pago BC';
    Description = '';
    ExternalName = 'bit_bcterminodepago';
    TableType = CRM;

    fields
    {
        field(1; bit_bcterminodepagoId; Guid)
        {
            Caption = 'Término de pago BC';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'bit_bcterminodepagoid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the Término de pago BC';
        ...
        field(14; statuscode; Option)
        {
            ...
            Description = 'Reason for the status of the Término de pago BC';
    ...
    keys
    {
        key(Key1; bit_bcterminodepagoId)
        {
        }
        key(Key2; bit_Nombre)
        {
