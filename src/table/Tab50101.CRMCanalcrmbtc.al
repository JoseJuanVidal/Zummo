table 50101 "CRM Canal_crm_btc"
{
    ...
    fields
    {
        field(1; zum_bccanalId; Guid)
        {
            Caption = 'Canal BC';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'zum_canalid';
        ...
        field(20; zum_Name; Text[100])
        {
            Caption = 'Nombre';
            Description = 'Required name field';
            ExternalName = 'zum_name';
            ExternalType = 'String';
        }
    }
