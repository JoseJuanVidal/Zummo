table 50145 "CRM Grupo Cliente_crm_btc"
{
    Caption = 'Grupo de Clientes';
    Description = '';
    ExternalName = 'zum_bcgrupocliente';
    TableType = CRM;

    fields
    {
        field(1; zum_bcgrupoclienteId; Guid)
        {
            Caption = 'Grupo de Clientes BC';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'zum_bcgrupoclienteid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the Grupo de Clientes BC';
        ...
        field(14; statuscode; Option)
        {
            ...
            Description = 'Reason for the status of the Grupo de Clientes BC';
        ...
        field(21; zum_Codigo; Text[100])
        {
            Caption = 'Código';
            Description = '';
            ExternalName = 'zum_codigo';
            ExternalType = 'String';
        }
        field(22; zum_Mercado; Guid)
        {
            Caption = 'Mercado';
            Description = '';
            ExternalName = 'zum_mercado';
            ExternalType = 'Lookup';
            TableRelation = "CRM Mercados_crm_btc".zum_MercadoId; // "CRM Mercados_btc".zum_MercadoId;
        }
    }

    keys
    {
        key(Key1; zum_bcgrupoclienteId)
        {
        }
        key(Key2; zum_Nombre)
        {
