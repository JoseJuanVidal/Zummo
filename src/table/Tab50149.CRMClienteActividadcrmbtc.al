table 50149 "CRM Cliente Actividad_crm_btc"
{
    Caption = 'Actividad de cliente';
    Description = '';
    ...
    fields
    {
        field(1; zum_bcactividadclienteId; Guid)
        {
            Caption = 'Actividad de cliente BC';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'zum_bcactividadclienteid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the Actividad de cliente BC';
        ...
        field(14; statuscode; Option)
        {
            ...
            Description = 'Reason for the status of the Actividad de cliente BC';
    ...
    keys
    {
        key(Key1; zum_bcactividadclienteId)
        {
        }
        key(Key2; zum_Nombre)
        {
