table 50144 "CRM ClienteCorporativo_crm_btc"
{
    ...
    fields
    {
        field(1;zum_bcclientecorporativoId;Guid)
        {
            Caption = 'Cliente corporativo';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'zum_bcclientecorporativoid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the Cliente corporativo';
        ...
        field(14;statuscode;Option)
        {
            ...
            Description = 'Reason for the status of the Cliente corporativo';
    ...
    keys
    {
        key(Key1;zum_bcclientecorporativoId)
        {
        }
        key(Key2;zum_Nombre)
        {
