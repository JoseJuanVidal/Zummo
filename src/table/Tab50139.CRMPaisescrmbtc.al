table 50139 "CRM Paises_crm_btc"
{
    Caption = 'País BC';
    Description = '';
    ...
    fields
    {
        field(1; bit_BCPaisId; Guid)
        {
            Caption = 'BC Pais';
            Description = 'Unique identifier for entity instances';
            ExternalAccess = Insert;
            ExternalName = 'bit_bcpaisid';
        ...
        {
            Caption = 'Status';
            Description = 'Status of the BC Pais';
        ...
        field(14; statuscode; Option)
        {
            ...
            Description = 'Reason for the status of the BC Pais';
        ...
        field(21; bit_CodigoISO; Text[100])
        {
            Caption = 'Código ISO';
            Description = '';
            ExternalName = 'bit_codigoiso';
            ExternalType = 'String';
        }
    }
