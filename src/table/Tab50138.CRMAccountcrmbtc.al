...
table 50138 "CRM Account_crm_btc"
{
    ...
    fields
    {
        ...
        //58.-PrimaryContactIdName
        //59.-ParentAccountIdName
        //60.-DefaultPriceLevelIdName
        ...
        field(117; LastUsedInCampaign; DateTime)
        {
        ...
        //118.-PreferredSystemUserIdName
        //119.-MasterAccountIdName
        ...
        field(122; OverriddenCreatedOn; DateTime)
        {
        ...
        //127.-TransactionCurrencyIdName
        field(1128; Aging30_Base; Decimal)
        {
        ...
        field(200; NAV_AccountStatisticsId; Guid) //En CSIDE 140 era AccountStatiticsId
        {
        ...
        //201.-AccountStatiticsName
        field(300; TimeSpentByMeOnEmailAndMeeting; Text[250])
        {
        ...
        field(301; PrimarySatoriId; Text[200])
        {
        ...
        field(302; PrimaryTwitterId; Text[128])
        {
        ...
        field(304; LastOnHoldTime; DateTime)
        {
        ...
        field(307; TeamsFollowed; Integer)
        {
        ...
        field(50000; bit_BCPais; Guid)
        {
            Caption = 'País BC';
            Description = 'Identificador del país de la cuenta procedente de Dynamics 365 Business Central';
            ExternalName = 'bit_bcpais';
            ExternalType = 'Lookup';
            TableRelation = "CRM Paises_crm_btc".bit_BCPaisId; // "CRM Paises_btc".bit_BCPaisId;
        }
        field(50001; bit_bcformadepago; Guid)
        {
            Caption = 'Forma de pago BC';
            Description = '';
            ExternalName = 'bit_bcformadepago';
            ExternalType = 'Lookup';
            TableRelation = "CRM FormasPago_crm_btc".bit_bcformadepagoId; // "CRM FormasPago_btc".bit_bcformadepagoId;
        }
        field(50002; bit_bcterminosdepago; Guid)
        {
            Caption = 'Términos de pago BC';
            Description = '';
            ExternalName = 'bit_bcterminosdepago';
            ExternalType = 'Lookup';
            TableRelation = "CRM TerminosPago_crm_btc".bit_bcterminodepagoId; // "CRM TerminosPago_btc".bit_bcterminodepagoId;
        }
        field(50003; zum_bcareamanager; Guid)
        {
            Caption = 'Área Manager BC';
            Description = '';
            ExternalName = 'zum_bcareamanager';
            ExternalType = 'Lookup';
            TableRelation = "CRM AreaManager_crm_btc".zum_bcareamanagerId;  // "CRM Area Manager_btc".zum_bcareamanagerId;
        }
        field(50004; zum_bcdelegado; Guid)
        {
            Caption = 'Delegado BC';
            Description = '';
            ExternalName = 'zum_bcdelegado';
            ExternalType = 'Lookup';
            TableRelation = "CRM Delegado_crm_btc".zum_bcdelegadoId; // "CRM Delegado_btc".zum_bcdelegadoId;
        }
        field(50005; zum_Descuento1; Decimal)
        {
            Caption = 'Descuento 1';
            Description = '';
            ExternalName = 'zum_descuento1';
            ExternalType = 'Decimal';
        }
        field(50006; zum_Descuento2; Decimal)
        {
            Caption = 'Descuento 2';
            Description = '';
            ExternalName = 'zum_descuento2';
            ExternalType = 'Decimal';
        }
        field(50007; zum_Prepago; Decimal)
        {
            Caption = 'Prepago (%)';
            Description = '';
            ExternalName = 'zum_prepago';
            ExternalType = 'Decimal';
        }
        field(50008; zum_Creditointerno; Decimal)
        {
            Caption = 'Crédito interno';
            Description = '';
            ExternalName = 'zum_creditointerno';
            ExternalType = 'Money';
        }
        field(50009; zum_creditointerno_Base; Decimal)
        {
            Caption = 'Crédito interno (Base)';
            Description = 'Value of the Crédito interno in base currency.';
            ExternalAccess = Read;
            ExternalName = 'zum_creditointerno_base';
            ExternalType = 'Money';
        }
        field(50010; zum_Creditoautorizadopor; Text[100])
        {
            Caption = 'Crédito autorizado por';
            Description = '';
            ExternalName = 'zum_creditoautorizadopor';
            ExternalType = 'String';
        }
        field(50011; zum_Creditoaseguradora; Decimal)
        {
            Caption = 'Crédito aseguradora';
            Description = '';
            ExternalName = 'zum_creditoaseguradora';
            ExternalType = 'Money';
        }
        field(50012; zum_creditoaseguradora_Base; Decimal)
        {
            Caption = 'Crédito aseguradora (Base)';
            Description = 'Value of the Crédito aseguradora in base currency.';
            ExternalAccess = Read;
            ExternalName = 'zum_creditoaseguradora_base';
            ExternalType = 'Money';
        }
        field(50013; bit_bcprovincia; Guid)
        {
        ...
        field(50014; zum_Fidelidad; Option)
        {
            Caption = 'Fidelidad';
            Description = '';
            ExternalName = 'zum_fidelidad';
            ExternalType = 'Picklist';
            InitValue = " ";
            OptionCaption = ' ,Alta,Media,Baja';
            OptionOrdinalValues = -1, 978740000, 978740001, 978740002;
            OptionMembers = " ",Alta,Media,Baja;
        }
        field(50015; zum_Potencial; Option)
        {
            Caption = 'Potencial';
            Description = '';
            ExternalName = 'zum_potencial';
            ExternalType = 'Picklist';
            InitValue = " ";
            OptionCaption = ' ,Alto,Medio,Bajo';
            OptionOrdinalValues = -1, 978740000, 978740001, 978740002;
            OptionMembers = " ",Alto,Medio,Bajo;
        }
        field(50016; zum_Captacion; Option)
        {
            Caption = 'Captación';
            Description = '';
            ExternalName = 'zum_captacion';
            ExternalType = 'Picklist';
            InitValue = " ";
            OptionCaption = ' ,Reactivo,Proactivo';
            OptionOrdinalValues = -1, 978740000, 978740001;
            OptionMembers = " ",Reactivo,Proactivo;
        }
        field(50017; zum_Rappel; Text[100])
        {
            Caption = 'Rappel';
            Description = '';
            ExternalName = 'zum_rappel';
            ExternalType = 'String';
        }
        field(50018; zum_Identificacionfiscal; Text[100])
        {
            Caption = 'Identificación fiscal';
            Description = '';
            ExternalName = 'zum_identificacionfiscal';
            ExternalType = 'String';
        }
        field(50019; zum_Condicionesespeciales; Text[100])
        {
            Caption = 'Condiciones especiales';
            Description = '';
            ExternalName = 'zum_condicionesespeciales';
            ExternalType = 'String';
        }
        field(50020; zum_SATpropio; Boolean)
        {
            Caption = 'SAT propio';
            Description = '';
            ExternalName = 'zum_satpropio';
            ExternalType = 'Boolean';
        }
        field(50021; zum_Marcas; Text[100])
        {
            Caption = 'Marcas';
            Description = '';
            ExternalName = 'zum_marcas';
            ExternalType = 'String';
        }
        field(50022; zum_Decisiondecompra; Option)
        {
            Caption = 'Decisión de compra';
            Description = '';
            ExternalName = 'zum_decisiondecompra';
            ExternalType = 'Picklist';
            InitValue = " ";
            OptionCaption = ' ,Local,Centralizada';
            OptionOrdinalValues = -1, 978740000, 978740001;
            OptionMembers = " ","Local",Centralizada;
        }
        field(50023; zum_Puntosdeventa; Text[100])
        {
            Caption = 'Puntos de venta';
            Description = '';
            ExternalName = 'zum_puntosdeventa';
            ExternalType = 'String';
        }
        field(50024; bit_bcenviaralerp; Boolean)
        {
            Caption = 'Enviar al ERP';
            Description = 'Los Leads creados en CRM para importarlos comoclientes NAV';
            ExternalName = 'bit_bcenviaralerp';
            ExternalType = 'Boolean';
        }
        field(50025; zum_grupodecliente; Guid)
        {
            Caption = 'Grupo de Cliente';
            Description = '';
            ExternalName = 'zum_grupodecliente';
            ExternalType = 'Lookup';
            TableRelation = "CRM Grupo Cliente_crm_btc".zum_bcgrupoclienteId; // "CRM Grupo Cliente_btc".zum_bcgrupoclienteId;
        }
        field(50026; zum_bcclientecorporativo; Guid)
        {
            Caption = 'Cliente corporativo BC';
            Description = '';
            ExternalName = 'zum_bcclientecorporativo';
            ExternalType = 'Lookup';
            TableRelation = "CRM ClienteCorporativo_crm_btc".zum_bcclientecorporativoId; // "CRM Cliente Corporativo_btc".zum_bcclientecorporativoId;
        }

        field(50027; zum_bcactividadcliente; Guid)
        {
            Caption = 'Cliente Actividad BC';
            Description = '';
            ExternalName = 'zum_bcactividadcliente';
            ExternalType = 'Lookup';
            TableRelation = "CRM Cliente Actividad_crm_btc".zum_bcactividadclienteId; // "CRM Cliente Actividad_btc".zum_bcactividadclienteId;
        }
        field(50028; zum_Formadepagosolicitada; Text[100])
        {
