codeunit 50115 "RemesaRegCerrada"
{
    ...
    var
        HasErrorsErr: Label 'The file export has one or more errors.\\For each line to be exported, resolve the errors displayed to the right and then try to export again.', Comment = 'ESP="La exportación del archivo tiene uno o más errores. \\ Para cada línea que se va a exportar, resuelva los errores que se muestran a la derecha y luego intente exportar nuevamente."';
    ...
    begin
        ...
        CODEUNIT.Run(CODEUNIT::"SepaPrepareSourceRegClos", TempDirectDebitCollectionEntry);
