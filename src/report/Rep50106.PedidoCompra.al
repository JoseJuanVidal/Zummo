report 50106 "Pedido Compra"
{
    RDLCLayout = './src/report/Rep50106.PedidoCompra.rdl';
    DefaultLayout = RDLC;
    Caption = 'Pedido Compra', Comment = 'Purchase Order';
    ...
    var
        ...
        ISOLbl: Label '5O.04_C4.01_V14', Comment = 'ESP="FO.04_C4.01_V15"';
