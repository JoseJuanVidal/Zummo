report 50115 "Service Quote Zummo"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/Rep50115.ServiceQuoteZummo.rdl';
    ...
    dataset
    {
        ...
        {
            DataItemTableView = SORTING("Document Type", "No.") WHERE(
            ...
            column(TipoPedidoNivel2_btc; TipoPedidoNivel2_btc)
            {
            ...
            column(TipoPedidoNivel2_btc_Caption; "Service Header".FieldCaption(TipoPedidoNivel2_btc))
            {
            ...
            column(CodAnterior_btc_Caption; "Service Header".fieldcaption(CodAnterior_btc))
            {
            ...
            area(content)
            {
                group(Options)
                {
                    ...
                    field(NoOfCopies; NoOfCopies)
                    {
                        ...
                        ToolTip = 'Specifies how many copies of the document to print.', Comment = 'ESP="Especifica cuántas copias del documento se van a imprimir."';
                    }
                    field(ShowInternalInfo; ShowInternalInfo)
                    {
                        ApplicationArea = Service;
                        Caption = 'Show Internal Information', Comment = 'ESP="Mostrar información interna"';
                        ToolTip = 'Specifies if you want the printed report to show information that is only for internal use.', Comment = 'ESP="Especifica si desea que el informe impreso muestre información para uso interno exclusivamente."';
                    }
                    field(LogInteraction; LogInteraction)
                    {
                        ...
                        ToolTip = 'Specifies if you want to record the service quotes that you want to print as interactions and add them to the Interaction Log Entry table.', Comment = 'ESP="Especifica si desea registrar las ofertas de servicio que desea imprimir como interacciones y agregarlas a la tabla Mov. log interacción."';
                    }
                }
            }
        }
    ...
    var
        Text001: Label 'Service Quote%1', Comment = 'ESP="Oferta servicio"';
        Text002: Label 'Page %1', Comment = 'ESP="Página %1"';
        ...
        SerHdrOrderDateCaptionLbl: Label 'Order Date', Comment = 'ESP="Fecha pedido"';
        InvoicetoCaptionLbl: Label 'Invoice to', Comment = 'ESP="Facturar a"';
        CompanyInfoPhoneNoCaptionLbl: Label 'Phone No.', Comment = 'ESP="Nº teléfono"';
        ServiceHeaderEMailCaptionLbl: Label 'Email', Comment = 'ESP="Correo electrónico"';
        HeaderDimensionsCaptionLbl: Label 'Header Dimensions', Comment = 'ESP="Dimensiones cabecera"';
        ServiceItemLinesCaptionLbl: Label 'Service Item Lines', Comment = 'ESP="Líns. prod. servicio"';
        FaultCommentsCaptionLbl: Label 'Fault Comments', Comment = 'ESP="Comentarios defecto"';
        ResolutionCommentsCaptionLbl: Label 'Resolution Comments', Comment = 'ESP="Comentarios resolución"';
        ServiceLineCaptionLbl: Label 'Service Line', Comment = 'ESP="Línea servicio"';
        AmtCaptionLbl: Label 'Amount', Comment = 'ESP="Importe"';
        GrossAmountCaptionLbl: Label 'Gross Amount', Comment = 'ESP="Importe bruto"';
        ...
        EmailCaptionLbl: Label 'Email', Comment = 'ESP="Correo electrónico"';
