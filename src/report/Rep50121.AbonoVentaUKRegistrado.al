report 50121 "AbonoVentaUKRegistrado"
{
    RDLCLayout = './src/report/Rep50121.AbonoVentaUKRegistrado.rdl';
    Caption = 'Posted Sales Credit Memo UK', comment = 'ESP="Abono ventas UK registrado"';
    ...
    dataset
    {
        dataitem("Sales Cr.Memo Header"; "Sales Cr.Memo Header")
        {
            ...
            column(CompanyInfoLogo; CompanyInfo1.Picture) { }
            ...
            column(CustomerEori; textCustomEORI) { }
            column(LabelCustomEori; textlblCustom) { }
            ...
            begin
                ...
                if Cust.EORI = '' then begin
                    ...
                    textCustomEORI := Cust.EORI;
                    textlblCustom := lblEORI;
                end;
            end;
