report 50131 "ExportN341ClosedPmtOrder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/POExportN341Closed.rdlc';
    ...
    dataset
    {
        dataitem("Payment Order"; "Closed Payment Order")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem("Cartera Doc."; "Closed Cartera Doc.")
                {
                    DataItemLink = "Bill Gr./Pmt. Order No." = FIELD("No.");
                    DataItemLinkReference = "Payment Order";
                    DataItemTableView = SORTING(Type, "Bill Gr./Pmt. Order No.", "Global Dimension 1 Code", "Global Dimension 2 Code") ORDER(Ascending) WHERE(Type = CONST(Payable));
                    ...
                    column(Cartera_Doc___Remaining_Amount_; "Amount for Collection")
                    {
                    }
                    ...
                    var
                        ...
                        ElectPmtMgmt2: Codeunit "Elect. Pmts Management";
                        transferType: Option National,International,Special;
                    begin
                        if PreviousAccountNo <> "Account No." then begin
                            ElectPmtMgmt2.GetTransferType("Account No.", "Amount for Collection", transferType, FALSE);
                            ...
                            ElectPmtMgmt.GetPayeeInfo("Account No.", VendorCCCBankNo, VendCCCBankBranchNo, VendCCCControlDigits, VendCCCAccNo,
                              PayeeAddress, PayeeCCC, IBAN, SwiftCode, transferType);
                            ...
                            if (CopyTxt = '') and not CurrReport.Preview then begin
                                ...
                                if (ActualTransferType <> transferType) and
                                ...
                                case transferType of
                                    transferType::National:
                                        begin
                                            ActualTransferType := transferType::National;
                                    ...
                                    transferType::International:
                                        begin
                                            ActualTransferType := transferType::International;
    ...
    var
        CarteraDoc: Record "Closed Cartera Doc.";
    begin
        CarteraDoc.SetCurrentKey(Type, "Bill Gr./Pmt. Order No.", "Global Dimension 1 Code", "Global Dimension 2 Code", "Currency Code", Status, Redrawn);
        ...
        if CarteraDoc.Find('-') then
            repeat
                ExportAmount := ExportAmount + CarteraDoc."Amount for Collection";
