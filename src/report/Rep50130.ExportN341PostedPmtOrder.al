report 50130 "ExportN341PostedPmtOrder"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/report/POExportN341.rdlc';
                ...
                dataitem("Cartera Doc."; "Posted Cartera Doc.")
                {
                    ...
                    begin
                        if PreviousAccountNo <> "Account No." then begin
                            ElectPmtMgmt2.GetTransferType("Account No.", "Remaining Amount", transferType, FALSE);
    ...
    begin
        CarteraDoc.SetCurrentKey(Type, "Bill Gr./Pmt. Order No.", "Global Dimension 1 Code", "Global Dimension 2 Code");
