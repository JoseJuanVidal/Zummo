report 50140 "Make 349 Declaration Zummo"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Make 349 Declaration Disk', Comment = 'ESP="Modelo 349 Diskete (Zummo)"';
    ProcessingOnly = true;
    UsageCategory = Tasks;
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    group("Operations EU")
                    {
                        Caption = 'Operations EU', Comment = 'ESP="Operaciones UE"';
                        field(FiscalYear; FiscalYear)
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Fiscal Year', Comment = 'ESP="Año Fiscal"';
                            Numeric = true;
                            ToolTip = 'Specifies the year of the reporting period. It must be 4 digits without spaces or special characters.', Comment = 'ESP="Especifica el año del período del informe. Debe tener 4 dígitos sin espacios ni caracteres especiales."';
                        }
                        field(Period; Period)
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Period', Comment = 'ESP="Periodo"';
                            OptionCaption = 'Annual,January,February,March,April,May,June,July,August,September,October,November,December,1st Quarter,2nd Quarter,3rd Quarter,4th Quarter', Comment = 'ESP="Anual,Enero,Febrero,Marzo,Abril,Mayo,Junio,Julio,Agosto,Septiembre,Octubre,Noviembre,Diciembre,1º Trimestre,2º Trimestre,3º Trimestre,4º Trimestre"';
                            ToolTip = 'Specifies the period that the report covers, such as a year, a month, or a quarter.', Comment = 'ESP="Especifica el período que cubre el informe, como un año, un mes o un trimestre."';
                        ...
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Period Frequency Change', Comment = 'ESP="Periodo Cambio de frecuencia"';
                            Enabled = PeriodFrequencyChangeEnable;
                            ToolTip = 'Specifies the period frequency of the report.', Comment = 'ESP="Especifica la frecuencia de período del informe."';
                        }
                        field(ContactName; ContactName)
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Contact Name', Comment = 'ESP="Nombre contacto"';
                            ToolTip = 'Specifies the name of the person making the declaration.', Comment = 'ESP="Especifica el nombre de la persona que hace la declaración"';
                        }
                        field(TelephoneNumber; ContactTelephone)
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Telephone Number', Comment = 'ESP="Nº teléfono"';
                            Numeric = true;
                            ToolTip = 'Specifies the telephone number of the contact person.', Comment = 'ESP="Especifica el nº de teléfono de la persona de contacto"';
                        ...
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Declaration Number', Comment = 'ESP="Nº Declaración"';
                            Numeric = true;
                            ToolTip = 'Specifies a number to identify the operations declaration.', Comment = 'ESP="Especifica el número que identifica las operaciones de la declaración"';
                        ...
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Company Country/Region', Comment = 'ESP="País/Región Empresa"';
                            TableRelation = "Country/Region";
                            ToolTip = 'Specifies the country/region for your company.', Comment = 'ESP="Especifica el país/región de su empresa."';
                        ...
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Declaration Media Type', Comment = 'ESP="Tipo de medio de declaración"';
                            OptionCaption = 'Physical support,Telematic', Comment = 'ESP="Soporte físico,Telemático"';
                            ToolTip = 'Specifies the media type for the declaration. To submit the declaration electronically, select Telematic. To submit the declaration on a CD-ROM, select Physical support.', Comment = 'ESP="Especifica el tipo de medio para la declaración. Para enviar la declaración electrónicamente, seleccione Telematic. Para enviar la declaración en un CD-ROM, seleccione Soporte físico."';
                        }
                        field(ColumnGPPG; ColumnGPPG)
                        {
                            ApplicationArea = Basic, Suite;
                            Caption = 'Excluded Gen. Product Posting Groups', Comment = 'ESP="Grupos de publicación de productos gen. Excluidos"';
                            Editable = false;
                            ToolTip = 'Specifies the general product posting group that you do not want to include in the declaration.', Comment = 'ESP="Especifica el grupo general de publicación de productos que no desea incluir en la declaración."';
    ...
    begin
        ...
        DeclarationMT := ' ';  //030320 S20/00561
    ...
    var
        Text1100000: Label 'Incorrect Fiscal Year.', Comment = 'ESP="Año fiscal incorrecto"';
        Text1100001: Label 'Contact name must be entered.', Comment = 'ESP="Debe especificar un nombre de contacto"';
        Text1100002: Label 'Contact telephone must be entered.', Comment = 'ESP="Debe especificar un teléfono de contacto"';
        Text1100003: Label 'Receipt number must be entered.', Comment = 'ESP="Se debe ingresar el número de recibo."';
        ...
        FromDate: Date;
        ToDate: Date;
        Text1100004: Label 'Company Country/Region must be entered.', Comment = 'ESP="Se debe ingresar el país/región de la empresa."';
        Text1100005: Label 'Please be aware that this file will contain posted entries of services transactions of EU Customers/Vendors if you did not fill \"Excluding Gen. Prod. Posting Groups" field.', Comment = 'ESP="Tenga en cuenta que este archivo contendrá entradas publicadas de transacciones de servicios de Clientes / Proveedores de la UE si no completó el campo \ "Excluyendo Gen. Prod. Grupos de publicación"."';
        Text1100006: Label 'Path to export 349 file.', Comment = 'ESP="Ruta para exportar el archivo 349."';
        Text1100007: Label 'Lenght should be 13 digits for Declaration Number.', Comment = 'ESP="La longitud debe ser de 13 dígitos para el número de declaración."';
        Text1100008: Label 'One or more Credit Memos were found for the specified period. \You can select the ones that require a correction entry in current declaration and specify the correction amount for them. \Would you like to specify these corrections?', Comment = 'ESP="Se encontraron uno o más Memos de crédito para el período especificado. \ Puede seleccionar los que requieren una entrada de corrección en la declaración actual y especificar la cantidad de corrección para ellos. \ ¿Desea especificar estas correcciones?"';
        Text1100009: Label 'No correction will be included in this declaration.', Comment = 'ESP="No se incluirá ninguna corrección en esta declaración."';
        Text1100010: Label '349 Declaration has been exported successfully under %1.', Comment = 'ESP="349 La declaración se ha exportado con éxito en %1."';
        AlreadyExported: Boolean;
        Text1100011: Label 'The process has been aborted. No file will be generated.', Comment = 'ESP="El proceso ha sido abortado. No se generará ningún archivo."';
        CompInfShipToCountryRegCode: Boolean;
        ReqFormCountryRegCode: Boolean;
        AllLocationsAreEU: Boolean;
        Text1100012: Label 'Telephone Number must be 9 digits without spaces or special characters.', Comment = 'ESP="El número de teléfono debe tener 9 dígitos sin espacios ni caracteres especiales."';
        Text1100013: Label 'The report is empty. File generation has been cancelled.', Comment = 'ESP="El informe está vacío. La generación de archivos ha sido cancelada."';
        Text1100014: Label 'The file already exists, do you want to replace it?', Comment = 'ESP="El archivo ya existe, ¿quieres reemplazarlo?"';
        Text1100015: Label 'At least one %1/%2 does not have any value in the %3 field. \Only Customers/Vendors with a value for %3 will be included in the file. \Do you still want to create the 349 Declaration file?',
            Comment = 'ESP="Al menos un %1 / %2 no tiene ningún valor en el campo %3. \ Solo los clientes / proveedores con un valor de %3 se incluirán en el archivo. \ ¿Todavía desea crear el archivo de declaración 349?"';
